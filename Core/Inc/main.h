...
#define ENABLEB_YAW_Pin GPIO_PIN_6
#define ENABLEB_YAW_GPIO_Port GPIOC
...
#define ENABLE_LASER_Pin GPIO_PIN_8
#define ENABLE_LASER_GPIO_Port GPIOC
#define ENABLEB_PITCH_Pin GPIO_PIN_9
#define ENABLEB_PITCH_GPIO_Port GPIOC
...
#define MS3_GPIO_Port GPIOD
#define RESETB_Pin GPIO_PIN_3
#define RESETB_GPIO_Port GPIOD
#define SLEEPB_Pin GPIO_PIN_4
#define SLEEPB_GPIO_Port GPIOD
#define STEP_PITCH_Pin GPIO_PIN_5
#define STEP_PITCH_GPIO_Port GPIOD
#define DIRECTION_Pin GPIO_PIN_6
#define DIRECTION_GPIO_Port GPIOD
#define BUTTON_DOWN_Pin GPIO_PIN_4
#define BUTTON_DOWN_GPIO_Port GPIOB
#define STEP_YAW_Pin GPIO_PIN_9
